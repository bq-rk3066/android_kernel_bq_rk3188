...
#if defined(CONFIG_BQ_D1012)||defined(CONFIG_BQ_D1014)||defined(CONFIG_BQ_D1015)
...
#if defined(CONFIG_BQ_D7803) || defined(CONFIG_BQ_D7005)
#define CONFIG_SENSOR_ORIENTATION_0 	  180
#elif defined(CONFIG_BQ_D7022) || defined(CONFIG_BQ_D1004)
...
#elif defined(CONFIG_BQ_D7803) || defined(CONFIG_BQ_D7005)
