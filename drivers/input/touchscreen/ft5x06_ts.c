...
E_UPGRADE_ERR_TYPE  fts_ctpm_fw_upgrade(FTS_BYTE* pbt_buf, FTS_DWRD dw_lenth)
{
    ...
    #if  (defined(CONFIG_BQ_D8009)||defined(CONFIG_BQ_D7022))
...
#ifdef CONFIG_FT5X0X_MULTITOUCH
#if (defined(CONFIG_BQ_C7022) ||defined(CONFIG_BQ_C7018)||defined(CONFIG_BQ_D7022) )
	switch(event->touch_point) {
		case 10:
