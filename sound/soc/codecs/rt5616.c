...
#if defined(CONFIG_BQ_D7005) || defined(CONFIG_BQ_D7803_Q7)
...
#if defined(CONFIG_BQ_D7005) || defined(CONFIG_BQ_D8006) || defined(CONFIG_BQ_D8009)||defined(CONFIG_BQ_D7022)
...
static const u16 rt5616_reg[RT5616_DEVICE_ID + 1] = {
...
#endif
#if defined(CONFIG_BQ_D7005)	//Modfied by EvanZeng for the volume of speaker is very high
	[RT5616_LOUT_CTRL1] = 0x9292,
#elif defined(CONFIG_BQ_D8009)//0.7W
	[RT5616_LOUT_CTRL1] = 0x9595,
#elif defined(CONFIG_BQ_C1017)
	[RT5616_LOUT_CTRL1] = 0x8787,
#elif defined(CONFIG_BQ_D1014)
	[RT5616_LOUT_CTRL1] = 0x8989,
#elif defined(CONFIG_BQ_D7022)// 1W 
	...
	[RT5616_LOUT_CTRL1] = 0x8989,
	#endif
#elif defined(CONFIG_BQ_D8006)	//Modfied by SolinLin for the volume of speaker is very high
...
#if defined(CONFIG_BQ_D7005)||defined(CONFIG_BQ_D8009)||defined(CONFIG_BQ_D7022)
	[RT5616_LOUT_CTRL2] = 0x8000,  //enable differential line output
#endif
	[RT5616_INL1_INR1_VOL] = 0x0808,
	[RT5616_DAC1_DIG_VOL] = 0xafaf,
#if defined(CONFIG_BQ_D8006)//Modfied by SolinLin for the volume of recording is very low
...
static void spk_ctrl_fun(int status)
{
	...
	if(rt5616_codec->spk_ctrl_io)
	{
		...
		if(status){
...
#if defined(CONFIG_BQ_D7005) || defined(CONFIG_BQ_D1013)
			...
			udelay(8);
			gpio_set_value(rt5616_codec->spk_ctrl_io, GPIO_HIGH);
#elif defined(CONFIG_BQ_D8009) || defined(CONFIG_BQ_D7806)
			//set audio pa mode to mode 2, 1.0w , xmtzqh
			gpio_set_value(rt5616_codec->spk_ctrl_io, GPIO_HIGH);
			udelay(2);
			gpio_set_value(rt5616_codec->spk_ctrl_io, GPIO_LOW);
...
#if defined(CONFIG_BQ_D7005)||defined(CONFIG_BQ_D7806)||defined(CONFIG_BQ_D1012)||defined(CONFIG_BQ_D8009)||defined(CONFIG_BQ_D7022)||defined(CONFIG_BQ_D1013)
